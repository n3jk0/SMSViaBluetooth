...
public class MyBluetoothService {
    private static final String TAG = "SMS_VIA_BLUETOOTH_TAG";
    ...
    public void startListening(BluetoothSocket socket) {
        ConnectedThread connectedThread = new ConnectedThread(socket);
        connectedThread.run();
    }

    public void sendTo(BluetoothSocket socket, String message) {
        ConnectedThread connectedThread = new ConnectedThread(socket);
...
//                    todo: check why this stops here second time
                    numBytes = mmInStream.read(mmBuffer);
                    System.out.println("Read: " + new String(mmBuffer));
        ...
        public void write(byte[] bytes) {
            try {
                ...
                System.out.println("Written: " + new String(bytes));
